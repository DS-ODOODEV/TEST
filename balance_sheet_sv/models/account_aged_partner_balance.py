...
class report_account_aged_receivable(models.AbstractModel):
    ...
    def _get_lines(self, options, line_id=None):
        ...
        total_1 = total_2 = total_3 = total_4 = total_5 = total_6 = total_7 = 0
        ...
        for values in results:
            if values['name'] == 'Unknown Partner' or values['name'] == 'Empresa desconocida':
                total_2 = total_2 + values['4']
                total_3 = total_3 + values['3']
                total_4 = total_4 + values['2']
                total_5 = total_5 + values['1']
                total_6 = total_6 + values['0']
                total_7 = total_7 + values['total']
                continue
            else:
                total_1 = total_1 + values['direction']
            vals = {
        ...
        if total and not line_id:
            total_line = {
                ...
                'columns': [{'name': ''}] * 4 + [{'name': self.format_value(sign * v), 'no_format': sign * v} for v in
                                                 [total_1, total[4]-total_2, total[3]-total_3, total[2]-total_4, total[1]-total_5, total[0]-total_6,
                                                  total[5]-total_7]],
            }
    ...
    def _get_lines(self, options, line_id=None):
        ...
        if total and not line_id:
            total_line = {
                ...
                'class': 'total',
                'level': 2,
                'columns': [{'name': ''}] * 4 + [{'name': self.format_value(sign * v), 'no_format': sign * v} for v in [total_1, total[4]-total_2, total[3]-total_3, total[2]-total_4, total[1]-total_5, total[0]-total_6, total[5]-total_7]],
            }
            lines.append(total_line)
        return lines