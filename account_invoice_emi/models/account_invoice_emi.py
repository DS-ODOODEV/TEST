...
class Account_Invoice_EMI(models.Model):
    ...
    currency_id = fields.Many2one('res.currency', string="Currency", readonly=False, required=False)
    company_id = fields.Many2one('res.company', 'Company', related="so_id.company_id")
    ...
    def action_view_invoice(self):
        invoices = [x.invoice_id.id for x in self.inv_emi_lines if x.invoice_id]
        print(self.inv_emi_lines)
...
class Account_Invoice_EMI_Line(models.Model):
    ...
    company_id = fields.Many2one('res.company', 'Company', related="acc_inv_emi_id.company_id", readonly=True, store=True)
    ...
    def create_invoice(self):
        ...
        for order in self.acc_inv_emi_id.so_id:
            ...
            invoice = inv_obj.create({
                ...
                'narration': self.inv_description,
